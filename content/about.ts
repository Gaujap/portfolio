 ...
 * A few specifics are inferred — flagged // TODO: verify.
 */
export const about: { intro: Localized[] } = {
  intro: [
    {
      en: "I'm a full-stack developer in Lyon, France, finishing an MSc in Computer Science with a security specialisation at Epitech (2027). I care about systems that hold up in production — the reliability, not the demo.", // TODO: verify graduation year
      fr: "Je suis développeur full-stack à Lyon, en train de finir un master d'informatique avec spécialisation sécurité à Epitech (2027). Ce qui m'intéresse, ce sont les systèmes qui tiennent en production — la fiabilité, pas la démo.", // TODO: verify graduation year
    },
    {
