...
- **Du matériel grand public, pas un datacenter.** Le modèle tourne sur un AMD **RX 7900 XTX** via **ROCm**, nettement moins mature que l'écosystème CUDA — bizarreries de pilotes, moins de wheels précompilées, et beaucoup de réglages manuels pour stabiliser **Qwen 2.5 14B** autour de 63 tok/s. {/* TODO: verify */}
