...
A fully working two-site prototype: segmented networks with a DMZ and bastion, a functioning site-to-site VPN, IPAM and topology documented in NetBox, and centralized logging in Elasticsearch — all validated end to end under nested KVM. It demonstrates a defensible architecture you can reason about: where the trust boundaries are, how admin access is controlled, and how you'd observe an incident. As an academic deliverable it did its job of proving the design end to end.
