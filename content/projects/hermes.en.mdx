...
A working local-first orchestrator I use daily: hands-free voice control end to end, NFC-triggered automations via tap, and a graceful degradation path to the cloud when the local model falls short. The tool registry made it cheap to add new capabilities, and the systemd services mean it's just there — no manual startup. The discipline of deepening a handful of workflows instead of sprawling paid off in something I actually trust.
